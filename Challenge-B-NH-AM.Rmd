...
### About the task 3, we have a problem when we run a step 3. We can not detail the time needed to run the steps in this task because of previous error message. We couldn't compile it correctly in pdf. The SIREN dataset was to big to be upload on github so please try to run the task 3, have a copy of the Siren file named "SIREN.csv". 
